...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errorMessage)) {
        ...
        $sql = "INSERT INTO registration (fname, mname, lname, address, zip, business_name, phone, email, business_address, 
                ...
                application_number, document_status, upload_dti, upload_store_picture, food_security_clearance, date_application, application_status) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt === false) {
            ...
            $stmt->bind_param(
                ...
                $uploadedFiles['upload_store_picture'],
        ...
        <div class="table-body ">
            <table id="myTable" >
                <tbody>
                    ...
                    <form class="row g-3" id="validated_form" method="post" action="registration.php" enctype="multipart/form-data">
