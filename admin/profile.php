                                ...
                                <div class="mb-3">
                                    <div class="card-box text-center">
                                        ...
                                        if ($fetch && !empty($fetch['image'])) {
                                            echo '<img src="assets/images/' . $fetch['image'] . '" style="height: 100px; width: 100px; border-radius: 50%; object-fit: cover;">';
                                        } else {
                                        ...
                                        <p class="text-muted">@System_Administrator_HMS</p>
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div class="tab-pane" id="settings">
                                                ...
                                                <input type="password" class="form-control" name="update_pass">
