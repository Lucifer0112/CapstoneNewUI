            ...
            <table id=" myTable" class=" table-striped table-bordered">
                <tbody>
                    <div id="displayDataTable">
                        <!-- admin_admin_list_displaydata.php -->
                    </div>
                </tbody>
            </table>
        </div>
...
<script>
    ...
    function displayData()
    {
        ...
        $.ajax
        ({
            url:"admin_list_displaydata.php",
            type:'post',
            data:{
    ...
    function getdetails(updateid)
    {
        ...
        $.post("admin_list_update.php", {updateid:updateid}, function(data,status)
        {
