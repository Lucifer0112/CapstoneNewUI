...
$select = mysqli_query($conn, "SELECT * FROM employee WHERE id = '$user_id'") or die(mysqli_error($conn));
...
if (isset($_POST['update_profile'])) {
    ...
    mysqli_query($conn, "UPDATE employee SET fname='$update_fname', lname='$update_lname', email='$update_email', phone='$update_phone', address='$update_address' WHERE id='$user_id'") or die(mysqli_error($conn));
    ...
    if (!empty($_POST['update_pass']) || !empty($_POST['new_pass']) || !empty($_POST['confirm_pass'])) {
        if ($update_pass != $old_pass) {
            ...
            mysqli_query($conn, "UPDATE employee SET password='$confirm_pass' WHERE id='$user_id'") or die(mysqli_error($conn));
    ...
    if (!empty($_FILES['update_image']['name'])) {
        ...
        if ($update_image_size > 2000000) {
            ...
            $image_update_query = mysqli_query($conn, "UPDATE employee SET image='$update_image' WHERE id='$user_id'") or die(mysqli_error($conn));
